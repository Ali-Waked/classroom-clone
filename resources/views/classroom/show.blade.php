<x-layout>
    ...
    <div class="classroom-details">
        <div class="classroom-image" id="classroom-image">
            ...
            @can('customise.apperance.classroom',[$classroom])
            ...
            <div class="content" id="code-contents">
                ...
                <div class="details">
                    ...
                    <div class="icon" id="copy-code-button" onclick="copyInvitationCodeForClassroom()">
                        ...
                        <span>{{__('Copy invitaion link')}}</span>
                    </div>
                    <div class="svg">
                        <svg focusable="false" width="24" height="24" viewBox="0 0 24 24" class=" NMm5M"
                            id="svg-NMm5M-one"
        ...
        <div class="classroom-content">
            ...
            @can('teacher',$classroom)
                    ...
                    <ul id="code-informations" class="hidden">
                        <li onclick="copyJoinLink(this);document.getElementById('code-informations').classList.toggle('hidden')"
                            ...
                            <a>
                                ...
                                <span>{{__('Copy class invite link')}}</span>
                            </a>
                        </li>
                ...
                <div class="upcoming">
                    <h6>{{__('Upcoming')}}</h6>
                    <span>{{__('No work due in soon')}}</span>
            ...
            <div class="right-side">
                <div class="announce">
                    ...
                    <span onclick="console.log('hi')">{{__('Announce something to your class')}}</span>
                    <svg focusable="false" width="24" height="24" viewBox="0 0 24 24" class=" NMm5M"
                        ...
                        @foreach ($classworks as $classwork)
                            <form action="{{ route('classwork.show', [$classroom->id, $classwork->id]) }}"
                                ...
                                <ul class="card-settings hidden" id="card-settings">
                                    <li>
                                        <a href="" class="disble">{{__('Move to up')}}</a>
                                    </li>
                                    <li>
                                        <a href="">{{__("Edit")}}</a>
                                    </li>
                                    <li>
                                        <a href="">{{__('Copy link')}}</a>
                                    </li>
                                </ul>
                            </form>
                        @endforeach
                ...
                @else
                    <div class="no-content">
                        ...
                        <div class="">
                            <h3>{{__('This is where you can talk to your class')}}</h3>
                            <p>{{__('Use the stream to share announcements, post assignments and respond to student questions')}}
                            </p>
                            <a href="">
    ...
    <section class="customise-apperance hidden" id="customise-apperance">
        ...
        <div class="conatiner-content">
            <div class="header">{{__('Customise apperance')}}</div>
            <div class="img">
                <img src="{{ $classroom->classroom_cover_image }}" alt="">
            </div>
            <form action="{{ route('classroom.customise.update', $classroom->id) }}" method="post"
                ...
                <div class="select-img">
                    <p>{{__('Select stream header image')}}</p>
                    <div>
                ...
                <div class="theme-title">{{__('Select theme colour')}}</div>
                ...
                <div class="buttons">
                    <button type="button"
                        onclick="document.getElementById('customise-apperance').classList.add('hidden')">{{__('Cancel')}}</button>
                    <button type="submit" style="pointer-events: auto; cursor: pointer;">{{__('Save')}}</button>
                </div>
            </form>
        </div>
    </section>
